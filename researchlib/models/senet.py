...
class SENet(nn.Module):
    def __init__(self, input_dim, block, num_blocks, num_classes=10):
...
def SENet18(input_dim=3): 
    return SENet(input_dim, PreActBlock, [2,2,2,2])
def SENet34(input_dim=3): 
    return SENet(input_dim, PreActBlock, [3,4,6,3])
