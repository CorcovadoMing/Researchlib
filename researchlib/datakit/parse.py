...
def ParseClassificationDataset(name: str, path: str, parse_format: str, phase: str, label_mapping: str = None, label_mapping_sep: str = None, force: bool = False) -> None:
    if force:
...
def ParseSegmentationDataset(name: str, path: str, parse_format: str, phase: str, label_mapping: str = None, label_mapping_sep: str = None, map_file: bool = True, force: bool = False) -> None:
    ...
    if ',' in parse_format:
        ...
        data_glob_pattern = label_glob_pattern = glob_pattern
