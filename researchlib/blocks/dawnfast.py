...
class _DAWNBlock(_Block):
    ...
    def __postinit__(self):
        ...
        self.stem = unit_fn(self.op, self.in_dim, self.out_dim, self.do_pool, self.do_norm, False, **self._get_custom_kwargs())
        self.res1 = unit_fn(self.op, self.out_dim, self.out_dim, False, self.do_norm, False, **self._get_custom_kwargs())
        self.res2 = unit_fn(self.op, self.out_dim, self.out_dim, False, self.do_norm, False, **self._get_custom_kwargs())
