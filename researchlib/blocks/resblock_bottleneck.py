...
def _ResBottleneckBlock(prefix, _unit, _op, in_dim, out_dim, **kwargs):
    ...
    first_conv_kwargs.update(kernel_size=1, 
                              stride=1, 
                              padding=0,
    ...
    second_conv_kwargs.update(kernel_size=kernel_size,
    ...
    third_conv_kwargs.update(kernel_size=1,
                              stride=1,
                              padding=0,
                              do_pool=False,
    ...
    conv_op = [
        ...
        _unit(f'{prefix}_m2', _op, hidden_size, hidden_size, **second_conv_kwargs), 
        op.Downsample(channels = hidden_size, filt_size = 3, stride = stride) if blur else None,
        _unit(f'{prefix}_m3', _op, hidden_size, out_dim, **third_conv_kwargs), 
