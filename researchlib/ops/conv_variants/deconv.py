...
#deconvolve channels
class _ChannelDeconv(nn.Module):
...
class _FastDeconv2d(conv._ConvNd):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1,groups=1,bias=True, eps=1e-5, n_iter=5, momentum=0.1, block=64, sampling_stride=3,freeze=False,freeze_iter=100, **kwargs):
        self.momentum = momentum
        self.n_iter = n_iter
        self.eps = eps
        self.counter=0
