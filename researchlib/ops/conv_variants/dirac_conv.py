...
class _DiracConv1d(nn.Conv1d, DiracConv):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, padding=0, dilation=1, bias=True, **kwargs):
...
class _DiracConv2d(nn.Conv2d, DiracConv):
    """Dirac parametrized convolutional layer.
...
class _DiracConv3d(nn.Conv3d, DiracConv):
    """Dirac parametrized convolutional layer.
